        ...
        <section class="profile-number">
          <a href="javascript:" class="profile-link" @click="toLogin">
            <!-- <div class="profile_image"> -->
              ...
              <img src="https://img2.woyaogexing.com/2019/11/12/be9fd192e58d479090e6f7aea49722ea!400x400.jpeg" class="profile_image" alt="头像">
            <!-- </div> -->
            <div class="user-info" >
    ...
    methods:{
      ...
      logout(){
        MessageBox.confirm('确定退出登录吗')
          .then(
            actionAgree => {this.$store.commit( LOGOUT );this.$router.replace('/login')},
