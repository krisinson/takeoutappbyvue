   ...
   <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 @click="isShowDetail=true" class="content-title">
    ...
    <div class="shop-brief-modal" v-show="isShowDetail" >
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-iconclose" @click="isShowDetail=false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="isShowDiscount" >
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-iconclose" @click="isShowDiscount=false"></span>
        </div>
      </div>
